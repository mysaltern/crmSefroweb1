...
/**
 * InvProductPrizesSearch represents the model behind the search form about `common\models\InvProductPrizes`.
 */
class InvProductPrizesSearch extends InvProductPrizes
{
    /**
     * @inheritdoc
     */
