...
use app\models\InvProductPrizesSearch;
...
/**
 * ProductprizesController implements the CRUD actions for InvProductPrizes model.
 */
class ProductprizesController extends Controller
    ...
    public function actionIndex()
        {
        $searchModel = new InvProductPrizesSearch();
    ...
    public function actionCreate()
        ...
        if ($request->isAjax)
            ...
            if ($request->isGet)
                {
                return [
                    'title' => "Create new InvProductPrizes",
    ...
    public function actionUpdate($id)
        ...
        if ($request->isAjax)
            ...
            if ($request->isGet)
                {
                return [
                    'title' => "Update InvProductPrizes #" . $id,
