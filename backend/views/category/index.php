...
/* @var $searchModel app\models\InvProductCategoriesSearch */
...
?>
<div class="inv-product-categories-index">
    <div id="ajaxCrudDatatable">
        ...
        GridView::widget([
            ...
            'toolbar' => [
                ['content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i>', ['create'], ['role' => 'modal-remote', 'title' => 'Create new Inv Product Categories', 'class' => 'btn btn-default']) .
            ...
            'panel' => [
                'type' => 'primary',
                'heading' => '<i class="glyphicon glyphicon-list"></i> لیست دسته بندی محصولات',
                'before' => '',
